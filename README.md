...
**What it does:**
Feed it a list of Windows API function names, and it gives you their ROR13 hashes; then embed those hashes in your shellcode instead of the raw strings. At runtime, your shellcode walks the PEB to find loaded modules, parses their export tables, hashes each function name, and compares the hashes against the precomputed values
...
**Heads up:**
ROR13 is not cryptographically secure, it's trivially reversible and full of collisions, and don't use it for anything that needs real secrecy. Its job is obfuscation, not encryption
